...
public class KiboApiService {
    ...
    public CatalogAdminsProduct updateProduct(String productCode, CatalogAdminsProduct product) throws ApiException {
        ProductsApi api = ProductsApi.builder().withConfig(config.getConfiguration()).build();
        return api.updateProduct(productCode, product);
    }
    ...
    public ProductInCatalogInfo updateProductInCatalog(String productCode, Integer catalogId, ProductInCatalogInfo productInfo) throws ApiException {
        ProductsApi api = ProductsApi.builder().withConfig(config.getConfiguration()).build();
        return api.updateProductInCatalog(productCode, catalogId, productInfo);
    }
    ...
    public CatalogAdminsAttributeCollection getAttributes(Integer startIndex, Integer pageSize) throws ApiException {
        ProductAttributesApi api = ProductAttributesApi.builder().withConfig(config.getConfiguration()).build();
        return api.getAttributes(startIndex, pageSize, null, null, null);
    }
    ...
    public CatalogAdminsProductOption createOption(String productCode, CatalogAdminsProductOption option) throws ApiException {
        ProductOptionsApi api = ProductOptionsApi.builder().withConfig(config.getConfiguration()).build();
        return api.addOption(productCode, option);
    }
